...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'greenpi' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
		<?php else : ?>
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'greenpi' ); ?></p>
			<?php
				get_search_form();
