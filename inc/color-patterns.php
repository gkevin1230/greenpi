 ...
 */
function greenpi_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'greenpi_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.greenpi-front-page) .entry-title,
...
.colors-custom .greenpi-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.greenpi-front-page .panel-content .recent-posts article,
...
.colors-custom.greenpi-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'greenpi_custom_colors_css', $css, $hue, $saturation );
}
